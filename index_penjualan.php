...
<h3>Bagian Penjualan</h3></center>
	<div class="container">
		...
		<div class="panel panel-default">
			<form action="login_act_penjualan.php" method="post">
				<div class="col-md-4 col-md-offset-4 kotak">
					...
					<td colspan="2" align="center">Belum punya akun? <a href="register_penjualan.php"><b>Register</b></a></td><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td colspan="2" align="center">Masuk ke Bagian Gudang <a href="index.php"><b>Disini</b></a></td>
					</div>
				</div>
			</form>
