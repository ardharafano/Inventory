...
<?php 
$per_hal=10;
$jumlah_record=mysqli_query($connect,"SELECT COUNT(*) from admin");
...
<table class="table">
	...
	if(isset($_GET['cari'])){
		...
		$brg=mysqli_query($connect, "select * from admin where kode like '$cari' or nama like '$cari'");
	}else{
		$brg=mysqli_query($connect, "select * from admin limit $start, $per_hal");
	}
	$no=1;
